...
- Вернуть количество объектов, значение поля shouldBeExpelled которых меньше заданного.
- Вернуть количество объектов, значение поля shouldBeExpelled которых больше заданного.
